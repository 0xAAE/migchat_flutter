...
class ChatRoomServiceClient extends $grpc.Client {
  static final _$register = $grpc.ClientMethod<$0.UserInfo, $0.Registration>(
  ...
  $grpc.ResponseFuture<$0.Registration> register($0.UserInfo request,
      {$grpc.CallOptions? options}) {
...
abstract class ChatRoomServiceBase extends $grpc.Service {
  ...
  ChatRoomServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.UserInfo, $0.Registration>(
        'Register',
        register_Pre,
        false,
        false,
  ...
  $async.Future<$0.Registration> register_Pre(
  ...
  $async.Future<$0.Registration> register(
